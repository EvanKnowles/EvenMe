...
public class Environment {
    ...
    public static Environment fromProperties() {
        ...
        e.neo4jURI = System.getProperty("NEO4J_URI");
        e.neo4jUser = System.getProperty("NEO4J_USER");
        e.neo4jPassword = System.getProperty("NEO4J_PASSWORD");
        return e;
    }

    public static Environment fromHardcode() {
        Environment e = new Environment();
        e.neo4jURI = "neo4j+s://URI";
        e.neo4jUser = "USER";
        e.neo4jPassword = "PASS";
